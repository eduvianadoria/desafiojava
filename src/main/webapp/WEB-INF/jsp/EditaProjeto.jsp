...
<head>
    <meta charset="UTF-8">
    <title>Desafio JAVA - Editar Projeto</title>
...
<body>
    ...
    <div class="container">
        ...
        <form:form action="/salvarEdicaoProjeto" method="post" modelAttribute="projeto">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="risco">Classificação de Risco</label>
            		<div class="col-md-6">
            		    <form:select path="risco" class="form-control input-sm">
                            <form:options items="${listaRisco}"></form:options>
                        </form:select>
            		</div>
            	</div>
            </div>
            ...
            <div class="row p-2">
               	<div class="col-md-2">
               		<button type="submit" value="Register" class="btn btn-success btn-block">Salvar</button>
               	</div>
